...
<script>
  ...
  import AddClassEnrolment from "$lib/components/student/AddClassroomEnrolment.svelte";
  ...
  import EditClassEnrolment from "$lib/components/student/EditClassroomEnrolment.svelte";
